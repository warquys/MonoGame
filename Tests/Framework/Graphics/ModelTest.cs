...
namespace MonoGame.Tests.Graphics
{
    ...
    internal sealed class ModelTest : GraphicsDeviceTestFixtureBase
    {
        ...
        public void ShouldDrawSampleModel()
        {
            ...
            var view = Matrix4x4.CreateLookAt(new Vector3(5, 5, 5), new Vector3(0, 0, 0), Vector3.Up);
            var projection = Matrix4x4.CreatePerspectiveFieldOfView(MathHelper.PiOver4, gd.Viewport.AspectRatio, 0.1f, 100.0f);
